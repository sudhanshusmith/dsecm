  ...
  var albireoApp = {
    ...
    menu_script: function () {
      ...
      if ($('.mobile-sidebar-menu').length && w < 1200) {
        var mobileMenu = $('.site-navigation .navigation')
          .clone()
          .appendTo('.mobile-sidebar-menu');
      }
      if (
        $('.site-header.header-style-one').length ||
        $('.site-header.header-style-three').length ||
        $('.site-header.header-style-four').length
      ) {
        var mobileMenu = $('.site-navigation .navigation')
          .clone()
          .appendTo('.mobile-sidebar-menu');
      ...
      if (
        $('.site-navigation .mainmenu').find('li > a').siblings('.sub-menu')
      ) {
        $('.mainmenu li > .sub-menu')
          .siblings('a')
          .append("<span class='menu-arrow icofont-simple-down'></span>");
      }
    ...
    onePageMenu: function () {
      if (
        $('.site-header.header-style-one').length ||
        $('.site-header.header-style-two').length ||
        $('.site-header.header-style-three').length ||
        $('.site-header.header-style-four').length ||
        $('.site-header.header-style-five').length
      ) {
        ...
        jQuery(this)
          .on('mouseenter', function () {
            if (jQuery(this).data('title')) {
              jQuery('.portfolio_mouseleve_title').html(
                '<h2 class="work__title">' +
                  jQuery(this).data('title') +
                  '</h2><span class="work__cat">' +
